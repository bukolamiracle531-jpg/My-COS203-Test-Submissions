...
def add_borrow_record():
    ...
    # Store each record on a new line, using '|' as a clear delimiter
...
def display_all_records():
    ...
    # vi. Handle the situation where the file does not yet exist
...
def display_total_borrowed():
    """Counts and displays the cumulative total number of books borrowed."""
